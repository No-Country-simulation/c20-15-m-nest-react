            ...
            <MDBRow className='justify-content-center align-items-center m-5'>
                ...
                <MDBCard>
                    <MDBCardBody className='px-4'>
                        ...
                        <h3 className="fw-bold mb-4 pb-2 pb-md-0 mb-md-5">Formulario de Registro</h3>
                        ...
                        <MDBRow>
                            ...
                            <MDBCol md='6'>
                                <MDBInput wrapperClass='mb-4' label='Telefono' size='lg' id='form3' type='rel' />
                            </MDBCol>
                            ...
                            <MDBCol md='6'>
                                <MDBInput wrapperClass='mb-4' label='DNI-CI' size='lg' id='form5' type='text' />
                            </MDBCol>
                        </MDBRow>
